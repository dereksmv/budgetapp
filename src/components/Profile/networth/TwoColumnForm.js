        ...
        Enter a number for each field
                    ...
                    <p className="flow-text">Enter your <b>{this.props.titleOfEntry}:</b></p>
                        <div className="col l6">
                            <input className="validate" id={this.props.input1} onChange={this.props.onChange} pattern="[0-9]+"></input>
                            <label htmlFor={this.props.for1}>{this.props.label1}</label>

                            <input className="validate" id={this.props.input2} onChange={this.props.onChange} pattern="[0-9]+"></input>
                            <label htmlFor={this.props.for2}>{this.props.label2}</label>

                            <input className="validate" id={this.props.input3} onChange={this.props.onChange} pattern="[0-9]+"></input>
                            <label htmlFor={this.props.for3}>{this.props.label3}</label>
  
                            <input className="validate" id={this.props.input4} onChange={this.props.onChange} pattern="[0-9]+"></input>
                            <label htmlFor={this.props.for4}>{this.props.label4}</label>
                        </div>
                        <div className="col l6">
                            

                            <input className="validate" id={this.props.input5} onChange={this.props.onChange} pattern="[0-9]+"></input>
                            <label htmlFor={this.props.for5}>{this.props.label5}</label>

                            
                            <input className="validate" id={this.props.input6} onChange={this.props.onChange} pattern="[0-9]+"></input>
                            <label htmlFor={this.props.for6}>{this.props.label6}</label>

                            <input className="validate" id={this.props.input7} onChange={this.props.onChange} pattern="[0-9]+"></input>
                            <label htmlFor={this.props.for7}>{this.props.label7}</label>
                            <br></br>
                            <br></br>
                            <br></br>
                            <button className="btn col l12 blue accent-3" type="SUBMIT" style={{marginBottom: "4em"}}>
                                Save
                            </button>
                        </div>
