...
fieldWhereTagsGo.textContent = ""
    ...
    componentDidMount() {
        ...
        document.getElementById("build-from-template").classList.remove("active")
                ...
                <div className="row">
                        <div>
                            ...
                            <ul className="tabs grey lighten-2 col s12" ref={Tabs => {this.Tabs = Tabs;}}>
                                ...
                                <li className="tab col s4"><a href="#NewTemp" className="active" id="new-template">New Template</a></li>
                            </ul>
                            </div>
                       </div>
